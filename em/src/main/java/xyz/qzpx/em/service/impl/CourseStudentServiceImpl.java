...
public class CourseStudentServiceImpl implements CourseStudentService {
    ...
    @Override
    public List<Integer> getStudentIdsNotInCourse(Integer courseId) {
        return null;
    }

    @Override
    public void rmStuToCourse(Integer id, Integer valueOf) {

    }

    @Override
    public List<CourseStudentDO> getCoursesByStuId(Integer id) {
        return null;
    }
    ...
    @Override
    public List<CourseStudentDO> getCoursesByStuAndSignUpId(Integer studentId, Integer signupId) {
        return null;
    }

    @Override
    public void delOriginalCourStu(CourseStudentVO courseStudentVO) {
        courseStudentDOMapper.deleteBySigndetailId(courseStudentVO.getSigndetailId());
    }

    @Override
    public void delBySigndetailId(Integer id) {
        courseStudentDOMapper.deleteBySigndetailId(id);
    }
