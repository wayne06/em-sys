...
<!--                    </div>-->
                ...
                <el-dialog :title="this.dTitle" :visible.sync="messageVisible" width="90%" @close="clear" top="3vh">
                    ...
                    <div class="handle-box">
                        <el-button :disabled="active==2?false:true" type="success" icon="el-icon-s-promotion" @click="submitTeacherCourse"
                                   style="float:right; margin-bottom: 20px" v-loading.fullscreen.lock="fullscreenLoading"
                        >提交</el-button>
                    </div>
